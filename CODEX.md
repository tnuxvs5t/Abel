...
不要把用户项目扩成大型框架。
不要幻想 Abel 已经有 registry、semver solver、download/cache、JIT、模块构建系统或成熟 IDE。当前只把项目入口、本地 path 依赖、lockfile、package graph consumption、add/remove/update/build 做成早期闭环。
