...
当前正在执行 public GitHub 发布准备：补充 README 与 proprietary/all-rights-reserved LICENSE。
```
...
3. GitHub 发布：完成本地 README/LICENSE commit 后，重新认证 GitHub CLI，创建 public `Abel` 仓库并 push。
```
...
待本次 public-readme-license 提交后追加 commit hash。
