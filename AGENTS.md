...
2. 下一批语言语义债建议聚焦：vector<struct>.resize 默认构造/default-constructible、runtime source location/stack trace、诊断去污染。
...
待本次 v1-semantic-consistency-implementation 提交后追加 commit hash。
