...
本轮文档任务：明确 v1.1 方针：v1.1-a 保持 Structured Calls；v1.1-b 改为强化 Abel SDK / Backend 承载复杂度，通过 backend-backed Abel surface 类型表达 map/复杂库能力，禁止把 map/object/dict/symbol/resource/dynamic invoke 做进内核。
```
